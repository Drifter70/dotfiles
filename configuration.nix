...

{
  ...
  # Enable the X11 windowing system.
   ...
   services.xserver.displayManager.gdm.enable = true; # display manager
   # window managers and DE's
  ...
  nixpkgs.overlays = [
    (self: super: {
      ...
      dwm = super.dwm.overrideAttrs (old: { src = /home/jeremy/.config/dwm ;});
	})
  ];
